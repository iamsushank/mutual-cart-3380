function fetchForm() {
  return `<fieldset id="signup_fieldset">
    <div id="padd_cont">
      <div id="next_cont_form" class="container_form">
        <form action="" class="forms_all" id="form_2">
          <a href="">
            <img
          ...
          <h2 id="welcome_text">Details about your company</h2>

          <!-- company name -->
          <div class="details_label">
            <span class="details comp_span" id="fullname">COMPANY NAME</span>
            <input type="text" class="input_box" />
          </div>

          <!-- country -->
          <div class="details_label">
            <span class="details comp_span" id="email">COUNTRY</span>
          ...
          <!-- conpany size -->
          <div class="details_label">
            <span class="details comp_span">COMPANY SIZE</span>
            <p id="email_label" class="label_in_gray">
          ...
          <!-- mobile number -->
          <div class="details_label signup_p2_mob">
            <span class="details comp_span" id="fullname"
              >MOBILE NUMBER (OPTIONAL)</span
            >
            <input type="text" class="input_box" />
          </div>
          ...
          <!-- dot logo -->
          <div id="two_circles">
            <span id="circle_field2"></span><span id="circle_unfield2"></span>
          </div>
        </form>
        <div id="spica">
          <img
